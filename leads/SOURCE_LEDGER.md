...
| **Architizer per-city lists** ("30 Best in \<city\>") | 2026-08-06 | 1 | 8 | **The better Architizer route.** Seattle returned 33 firms, nearly all small studios, with a high overlap rate against the catalog (5 already held) confirming it covers the same ground other Seattle sources found. **Chicago and San Francisco lists exist and are untouched**; no Denver, Portland, Minneapolis or Austin editions |
| Architizer A+List | — | 0 | — | |
