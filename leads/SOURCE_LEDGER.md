...
| Source | Last used | Times | Firms yielded | Notes |
|---|---|---|---|---|
| RIBA regional awards | 2026-08-12 | 3 | 24 (15 earlier + 9: Like Architects, McGarry-Moon, Marshall McCann [NI]; James Gorst, Gort Scott, VATRAA, Pitman Tozer, Edgley Design, alma-nac, Paul Archer Design, Gbolade Design Studio, Gianni Botsford, Sanchez Benton, Bell Phillips, Lynch Architects [London]) | Northern Ireland (RSUA, via architectsjournal.co.uk) and London (72-project shortlist, via riba.org since AJ's own London-shortlist page 403'd but riba.org's press release fetched fine) both done this pass. RIAS/Scotland is a **separate body, not RIBA** — its awards site had no direct crawlable list, but WebSearch snippets + one summary article yielded 6 firms (GRAS, jmarchitects, Collective Architecture, Studio Octopi, Hoskins Architects) cleanly. Still untouched: East, West Midlands (partially covered already), South West/Wessex (partially covered), Wales (partially covered) |
