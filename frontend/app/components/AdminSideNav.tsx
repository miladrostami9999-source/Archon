...
import { LayoutDashboard, Users, DollarSign, HeartPulse, Settings, Search, Globe2, Activity } from 'lucide-react'
...
const NAV_ITEMS = [
  ...
  { key: 'product-health', href: '/admin/product-health', label: 'Product Health', Icon: Activity },
