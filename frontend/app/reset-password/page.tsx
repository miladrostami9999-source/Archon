          ...
          {done ? (
            ...
            <>
              ...
              <button onClick={submit} disabled={loading || !token}
                style={{ width: '100%', padding: '12px', borderRadius: '10px', fontSize: '14px', fontWeight: 600, color: 'white', background: (loading || !token) ? 'rgba(61,79,224,0.5)' : 'linear-gradient(135deg, #3D4FE0, #2E3BB0)', border: 'none', cursor: (loading || !token) ? 'not-allowed' : 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px' }}>
