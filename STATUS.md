...
- ⏸ **Data Collection Campaign** — این یک کار **تجاری/دستی** است نه کدنویسی: جمع‌آوری ۳۰۰۰ شرکت verified در ۶ ماه. ابزارهاش آماده‌ست (Import CSV، AI Research، AI Lead Discovery).
- ⏸ **قفل کشورها برای پلن trial** — نمایش فقط چند کشور محدود برای کاربران trial و قفل بقیه
